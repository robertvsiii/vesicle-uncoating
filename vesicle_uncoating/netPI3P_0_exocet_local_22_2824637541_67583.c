...
void dres_dN3k0_(double *time_ptr, double *dynamicVars, double *yprime, double *constants, double *pd);

void dres_dN4k0_(double *time_ptr, double *dynamicVars, double *yprime, double *constants, double *pd);

void dres_dkcon0_(double *time_ptr, double *dynamicVars, double *yprime, double *constants, double *pd);
...
double v_close = constants[5];
double CLTAmax = constants[6];
double kcat = constants[7];
double KM = constants[8];
double N3k0 = constants[9];
double N4k0 = constants[10];
double N5p0 = constants[11];
double N3k40 = constants[12];
double knet = constants[13];
double ku0 = constants[14];
double ku1 = constants[15];
double ku2 = constants[16];
double fleak = constants[17];
double tsciss = constants[18];
double delay = constants[19];
double kcon0 = constants[20];
double kcoff = constants[21];
double klon_max = constants[22];
double Nprobe = constants[23];
double kloffPI3P = constants[24];
...
double circ = sqrt(abs(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0)));
...
residual[8] = kcat*switch0*N3k*PI/(PI + KM) + kloffPI3P*probePI3P + kloffPI3P*probeCLTAPI3P - kcat*switch0*N4k*PI3P/(PI3P + KM) - klon*Nprobe*PI3P - klonb*probeCLTA*PI3P - yprime[8];
...
residual[13] = ku*probeCLTAPI3P + klon*Nprobe*PI3P + kcoff*probeCLTAPI3P - kconb*probePI3P*CLTAfree - kloffPI3P*probePI3P - yprime[13];
...
pd[64] = kc*(1.0 - switch0)*abs_0(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0))*(1.0/CLTAmax - CLTA*2.0/pow(CLTAmax, 2.0))*0.166666666667/sqrt(abs(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0)))*3.0 - ku - CLTAfree*(((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*abs_0(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0))*(1.0/CLTAmax - CLTA*2.0/pow(CLTAmax, 2.0))*0.166666666667/sqrt(abs(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0)))/(CLTA + 0.01) + (((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*fleak/(CLTA + 0.01) - ((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*(circ + fleak*CLTA)/pow(CLTA + 0.01, 2.0))*0.333333333333) - kcon*Nprobe - kconb*probePI3P;
...
pd[184] = kcoff + kc*(1.0 - switch0)*abs_0(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0))*(1.0/CLTAmax - CLTA*2.0/pow(CLTAmax, 2.0))*0.166666666667/sqrt(abs(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0)))*3.0 - CLTAfree*(((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*abs_0(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0))*(1.0/CLTAmax - CLTA*2.0/pow(CLTAmax, 2.0))*0.166666666667/sqrt(abs(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0)))/(CLTA + 0.01) + (((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*fleak/(CLTA + 0.01) - ((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*(circ + fleak*CLTA)/pow(CLTA + 0.01, 2.0))*0.333333333333);
pd[199] = -(kconb*CLTAfree);
pd[214] = kcoff + kc*(1.0 - switch0)*abs_0(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0))*(1.0/CLTAmax - CLTA*2.0/pow(CLTAmax, 2.0))*0.166666666667/sqrt(abs(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0)))*3.0 - CLTAfree*(((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*abs_0(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0))*(1.0/CLTAmax - CLTA*2.0/pow(CLTAmax, 2.0))*0.166666666667/sqrt(abs(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0)))/(CLTA + 0.01) + (((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*fleak/(CLTA + 0.01) - ((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*(circ + fleak*CLTA)/pow(CLTA + 0.01, 2.0))*0.333333333333);
...
pd[128] = kcat*switch0*N4k*PI3P/pow(PI3P + KM, 2.0) - kcat*switch0*N4k/(PI3P + KM) - klon*Nprobe - klonb*probeCLTA;
pd[188] = -(klonb*PI3P);
pd[203] = kloffPI3P;
pd[218] = kloffPI3P;
...
pd[72] = kcon*Nprobe - probeCLTA*(((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*abs_0(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0))*(1.0/CLTAmax - CLTA*2.0/pow(CLTAmax, 2.0))*0.166666666667/sqrt(abs(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0)))/(CLTA + 0.01) + (((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*fleak/(CLTA + 0.01) - ((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*(circ + fleak*CLTA)/pow(CLTA + 0.01, 2.0))*0.333333333333);
...
pd[192] = -ku - probeCLTA*(((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*abs_0(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0))*(1.0/CLTAmax - CLTA*2.0/pow(CLTAmax, 2.0))*0.166666666667/sqrt(abs(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0)))/(CLTA + 0.01) + (((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*fleak/(CLTA + 0.01) - ((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*(circ + fleak*CLTA)/pow(CLTA + 0.01, 2.0))*0.333333333333) - klonb*PI3P - kcoff;
pd[222] = kloffPI3P - probeCLTA*(((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*abs_0(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0))*(1.0/CLTAmax - CLTA*2.0/pow(CLTAmax, 2.0))*0.166666666667/sqrt(abs(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0)))/(CLTA + 0.01) + (((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*fleak/(CLTA + 0.01) - ((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*(circ + fleak*CLTA)/pow(CLTA + 0.01, 2.0))*0.333333333333);
pd[73] = probeCLTAPI3P*(((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*abs_0(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0))*(1.0/CLTAmax - CLTA*2.0/pow(CLTAmax, 2.0))*0.166666666667/sqrt(abs(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0)))/(CLTA + 0.01) + (((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*fleak/(CLTA + 0.01) - ((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*(circ + fleak*CLTA)/pow(CLTA + 0.01, 2.0))*0.333333333333) - kconb*probePI3P;
...
pd[133] = klon*Nprobe;
pd[193] = probeCLTAPI3P*(((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*abs_0(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0))*(1.0/CLTAmax - CLTA*2.0/pow(CLTAmax, 2.0))*0.166666666667/sqrt(abs(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0)))/(CLTA + 0.01) + (((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*fleak/(CLTA + 0.01) - ((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*(circ + fleak*CLTA)/pow(CLTA + 0.01, 2.0))*0.333333333333);
pd[208] = -(kconb*CLTAfree) - kloffPI3P;
pd[223] = ku + kcoff + probeCLTAPI3P*(((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*abs_0(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0))*(1.0/CLTAmax - CLTA*2.0/pow(CLTAmax, 2.0))*0.166666666667/sqrt(abs(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0)))/(CLTA + 0.01) + (((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*fleak/(CLTA + 0.01) - ((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*(circ + fleak*CLTA)/pow(CLTA + 0.01, 2.0))*0.333333333333);
pd[74] = kconb*probePI3P - probeCLTAPI3P*(((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*abs_0(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0))*(1.0/CLTAmax - CLTA*2.0/pow(CLTAmax, 2.0))*0.166666666667/sqrt(abs(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0)))/(CLTA + 0.01) + (((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*fleak/(CLTA + 0.01) - ((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*(circ + fleak*CLTA)/pow(CLTA + 0.01, 2.0))*0.333333333333);
...
pd[194] = klonb*PI3P - probeCLTAPI3P*(((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*abs_0(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0))*(1.0/CLTAmax - CLTA*2.0/pow(CLTAmax, 2.0))*0.166666666667/sqrt(abs(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0)))/(CLTA + 0.01) + (((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*fleak/(CLTA + 0.01) - ((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*(circ + fleak*CLTA)/pow(CLTA + 0.01, 2.0))*0.333333333333);
pd[209] = kconb*CLTAfree;
pd[224] = -ku - probeCLTAPI3P*(((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*abs_0(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0))*(1.0/CLTAmax - CLTA*2.0/pow(CLTAmax, 2.0))*0.166666666667/sqrt(abs(CLTA/CLTAmax - pow(CLTA/CLTAmax, 2.0)))/(CLTA + 0.01) + (((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*fleak/(CLTA + 0.01) - ((1.0 - switch1)*((1.0 - switch0)*ku0 + switch0*ku1) + switch1*ku2)*(circ + fleak*CLTA)/pow(CLTA + 0.01, 2.0))*0.333333333333) - kloffPI3P - kcoff;
}
...
pd[4] = -(probePI3P*CLTAfree*0.333333333333/(v_close*CLTAmax)) - Nprobe*CLTAfree*0.333333333333/CLTAmax;
pd[12] = Nprobe*CLTAfree*0.333333333333/CLTAmax;
pd[13] = -(probePI3P*CLTAfree*0.333333333333/(v_close*CLTAmax));
pd[14] = probePI3P*CLTAfree*0.333333333333/(v_close*CLTAmax);
}
...
int p_index = (int)constants[25];
double constants_only[25];
int jj;
for (jj = 0; jj < 25; jj++){
...
switch(p_index)
{
case 0 : dres_dN3k0_(time_ptr, sens_y, sens_yp, constants_only, local_dres_dp);
break;
case 1 : dres_dN4k0_(time_ptr, sens_y, sens_yp, constants_only, local_dres_dp);
break;
case 2 : dres_dkcon0_(time_ptr, sens_y, sens_yp, constants_only, local_dres_dp);
break;
case 3 : dres_dkloffPI3P_(time_ptr, sens_y, sens_yp, constants_only, local_dres_dp);
break;
}
